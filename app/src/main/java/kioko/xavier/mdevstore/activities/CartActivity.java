...
import kioko.xavier.mdevstore.base.InputFilterMinMax;
...
//        scroll.removeAllViewsInLayout();
                ...
                runOnUiThread(() -> {
                    ...
                    try {
                        ...
                        if (result.length() > 0) {
                            ...
                            Toast.makeText(getApplicationContext(), "There is nothing here yet", Toast.LENGTH_LONG).show();
                        }
    ...
    public void addProduct(JSONObject JSONproduct, LinearLayout layout) throws
        ...
        maxProductCol.setText("Maximum amount: " + col);
