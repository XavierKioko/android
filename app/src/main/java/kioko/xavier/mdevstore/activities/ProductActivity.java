                            ...
                            runOnUiThread(() -> {
                                ...
                                try {
                                    ...
                                    try {
                                        ...
                                        productCol.setText("In stock: " + col + " шт.");
                                        if (col == 0) {
                                            hideFAB = true;
                                            productAddToCart.hide();
                                            Snackbar bar = Snackbar.make(findViewById(android.R.id.content), "Not available", Snackbar.LENGTH_INDEFINITE);
                                            bar.setAction("ОК", v -> {
                                                bar.dismiss();
                                            });
                                            bar.show();
                                            productCol.setText("Not available");
                                        }
